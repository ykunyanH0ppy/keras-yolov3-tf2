...
class YoloLayer(Layer):
    ...
    def call(self, x):
        ...
        if debug:
            ...
            loss = tf.compat.v1.Print(loss, [grid_h, tf.reduce_mean(loss_xy),
                                        tf.reduce_mean(loss_wh),
                                        tf.reduce_mean(loss_conf),
                                        tf.reduce_mean(loss_class)],  message='loss xy, wh, conf, class: \t',   summarize=1000)
